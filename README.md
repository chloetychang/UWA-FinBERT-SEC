...
- In the absence of human-annotated labels, the model is trained using pseudo-labels generated by applying FinBERT to the original SEC press release parquet file.
- Only high-confidence predictions (confidence > 95%) are retained to reduce label noise and improve label reliability.
